...
Get-ChildItem -Path "$TargetPath" | Where-Object {$_.Name -match "(.*)jdk18(.*)"} | ForEach-Object {
	Remove-Item -Recurse -Force -Path "$($_.FullName)"
}

if("$env:JAVA_HOME_18" -ne ""){
	[System.Environment]::SetEnvironmentVariable('JAVA_HOME_18', $null, [System.EnvironmentVariableTarget]::User)
}