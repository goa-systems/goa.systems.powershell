...
if([string]::IsNullOrEmpty($UninstallString)){
	...
	$UninstallString = Get-UninstString -RegKey "HKCU:\Software\Microsoft\Windows\CurrentVersion\Uninstall" -DisplayName "Mozilla Firefox"
}
...
$UninstallString = Get-UninstString -RegKey "HKLM:\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall" -DisplayName "Mozilla Firefox"
...
$UninstallString = Get-UninstString -RegKey "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall" -DisplayName "Mozilla Firefox"
